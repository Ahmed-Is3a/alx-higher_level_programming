...
def matrix_mul(m_a, m_b):
    ...
    Args:
        m_a (list): Matrix A, a list of lists of integers or floats.
        m_b (list): Matrix B, a list of lists of integers or floats.

    Returns:
        list: Result of the matrix multiplication.

    Raises:
        TypeError: If m_a or m_b is not a list, not a list of lists, or contains non-integer/non-float elements.
